<div align="center">
  ...
  외국인과 한국 기업을 연결하는 **LinkJob** 앱을 개발하고 있습니다.
  React Native와 Expo를 활용한 크로스 플랫폼 모바일 앱 개발을 전문으로 합니다.

  - 🔭 현재 **LinkJob** - 말 통하는 외국인 채용 플랫폼 개발 중
  - 💼 **(주)웰킷** 소속
  - 🌍 12개 언어 지원 앱 개발 경험
  - 📱 iOS & Android 동시 배포 경험
  ...
  **LinkJob** - 한국에서 일자리를 찾는 외국인과 외국인 직원을 찾는 기업을 연결하는 모바일 플랫폼

  ### ✨ Key Features
  - 📍 GPS 기반 근거리 일자리 매칭
  - 🎓 내장 한국어 능력 검증 시스템
  - 💬 12개 언어 실시간 번역 채팅
  - 🔄 Socket.io 기반 실시간 커뮤니케이션
  ...
  - 📧 Email: simsgood0807@gmail.com
  - 🌐 Website: [linkjob.kr](https://linkjob.kr)
  - 💼 Company: welkit.answer@gmail.com
